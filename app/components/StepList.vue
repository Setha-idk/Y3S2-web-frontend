    ...
    <div v-for="step in task.steps" :key="step.id" class="step-item group">
      <div class="flex items-center justify-between">    
        <div class="flex items-center gap-2">
          ...
          ></span>
          <span class="text-sm text-gray-500 ml-2">{{ step.status }}</span>
          
          <!-- Step Name -->
          <span class="text-gray-800">{{ step.name }}</span>
          <div>
            <span class="text-sm text-gray-500 ml-2">description: {{ step.description }}</span>
          </div>
        </div>
